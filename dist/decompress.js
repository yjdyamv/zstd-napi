...
exports.DecompressStream = exports.Decompressor = void 0;
...
function getTotalContentSize(buffer) {
    let result = 0;
    let frame = buffer;
...
class Decompressor {
    ...
    decompress(buffer) {
        ...
        if (contentSize !== null) {
            ...
            assert_1.strict.equal(decompressedSize, contentSize);
            return result;
        }
    ...
    _transform(chunk, _encoding, done) {
        ...
        try {
            ...
            for (;;) {
                ...
                const [ret, produced, consumed] = this.dctx.decompressStream(dstBuf, srcBuf);
                if (produced > 0)
